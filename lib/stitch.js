...
(function() {
  ...
  exports.Package = Package = (function() {
    ...
    function Package(config) {
      ...
      this.ignore = (_ref4 = config.ignore) != null ? _ref4 : [];
      this.listModules = (_ref5 = config.listModules) != null ? _ref5 : false;
      this.listModulesIdentifier = (_ref6 = config.listModulesIdentifier) != null ? _ref6 : 'modules';
      this.cache = (_ref7 = config.cache) != null ? _ref7 : true;
      this.mtimeCache = {};
      this.compileCache = {};
    }
    ...
    Package.prototype.compileSources = function(callback) {
      ...
      return async.reduce(this.paths, {}, _.bind(this.gatherSourcesFromPath, this), function(err, sources) {
        var filename, index, name, names, result, source, stringifiedName, _ref1;
        if (err) {
          return callback(err);
        }
        ...
        if (_this.listModules) {
          source = JSON.stringify(names);
          result += index++ === 0 ? "" : ", ";
          result += _this.listModulesIdentifier;
